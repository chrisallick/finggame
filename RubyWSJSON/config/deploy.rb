...
set :runner, "#{user}"
set :scm, :git
set :repository, "git@github.com:Elepath/trash.git"
set :local_repository, "git@github.com:Elepath/trash.git"
set :key_pair, "squetch"
set :rvm_type, :system

ssh_options[:keys] = "~/.ssh/#{key_pair}.pem"
server "stage.trash.io", :app, :primary => true
